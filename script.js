const images = {
    about: [
        { text: `<h1>Welcome!</h1>
                ...
                <p>The equipment I'm currently using: Sky-Watcher BK 1309 EQ2 130/900, Lenovo thinkpad x230, ND96-0.9, ZWO UV/IR Cut (1,25"), EQ-2 RA motor drive, Super 25mm(36x), 10mm (90x), 5mm (x257), Barlow lens x2, Barlow lens x1. For photos, I use Xiaomi Mi 10T Pro, Canon 450d, Jupiter37a. ZWO ASI 662MC.</p>
